                    ...
                    if(projectPluginIds.containsKey(project.getName())) {
                        ...
                        if(!project.getName().endsWith("core")) {
                            ...
                            if(Files.exists(coreModule)) {
                                var coreProjectDep = project.getDependencies().project(Map.of("path", ":" + projectIdPrefix  + project.getBuildFile().toPath().getParent().getParent().getParent().getFileName() + "-core"));
