                                ...
                                if(projectPluginIds.containsKey(project.getName())) {
                                    ...
                                    if(project.getName().endsWith("-mapping")) {
                                        ...
                                        if(Files.exists(coreModule)) {
                                            var coreProjectDep = project.getDependencies().project(Map.of("path", ":" + projectIdPrefix  + rootModule.getFileName() + "-usecase-" + parentModule.getFileName() + "-core"));
                                    ...
                                    if(project.getName().endsWith("-implementation")) {
                                        ...
                                        if(Files.exists(mappingModule)) {
                                            var mappingProjectDep = project.getDependencies().project(Map.of("path", ":" + projectIdPrefix  + rootModule.getFileName() + "-usecase-" + parentModule.getFileName() + "-mapping"));
