...
import org.mifos.convention.project.base.extension.MifosExtension;
...
public class MifosProjectRootPlugin implements Plugin<Project> {
    ...
    public void apply(Project project) {
        var mifosExtension = project.getExtensions().create("mifos", MifosExtension.class);
        /*
        mifosExtension.getProjects().getByName("xxx", mifosProject -> {
        ...
        */
        ...
        // TODO: avoid the subproject thing alltogether, because we can retrieve the mifos extension in the base project and apply maven publishing
        project.subprojects(subproject -> {
            subproject.afterEvaluate(sp -> {
                sp.setVersion(project.getRootProject().getVersion());
