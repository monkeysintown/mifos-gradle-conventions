...
public final class MifosProjectConstants {
    ...
    public static final String MIFOS_PROJECT_DEFAULT_SPRING_BOOT_VERSION = "40"; // 35, 41
    ...
    public static final String MIFOS_PROJECT_SUFFIX_CORE = "-core";
    public static final String MIFOS_PROJECT_SUFFIX_MAPPING = "-mapping";
    public static final String MIFOS_PROJECT_SUFFIX_IMPLEMENTATION = "-implementation";
    public static final String MIFOS_PROJECT_SUFFIX_STARTER = "-starter";
    public static final String MIFOS_PROJECT_SUFFIX_DATABIND = "-databind";
    public static final String MIFOS_PROJECT_SUFFIX_PERSISTENCE = "-persistence";
    public static final String MIFOS_PROJECT_SUFFIX_SERVICE = "-service";
    public static final String MIFOS_PROJECT_SUFFIX_SUPPORT = "-support";
    public static final String MIFOS_PROJECT_SUFFIX_USECASE = "-usecase";
    public static final String MIFOS_PROJECT_SUFFIX_SDK = "-sdk";
    public static final String MIFOS_PROJECT_SUFFIX_CLI = "-cli";
    public static final String MIFOS_PROJECT_SUFFIX_BACKEND = "-backend";
    public static final String MIFOS_PROJECT_SUFFIX_MIGRATION = "-migration";
    public static final String MIFOS_PROJECT_SUFFIX_BFF = "-bff";
    public static final String MIFOS_PROJECT_SUFFIX_VAADIN = "-vaadin";
    public static final String MIFOS_PROJECT_SUFFIX_JSF = "-jfs";
    ...
    public static final List<String> MIFOS_PROJECT_BOOT_STARTER_SUB_MODULES = List.of("persistence", "service", "usecase", "support", "transport");
    ...
    public static final List<String> MIFOS_PROJECT_BOOT_SERVICE_MODULES = List.of("core", "implementation", "mapping", "starter");
    public static final List<String> MIFOS_PROJECT_BOOT_USECASE_MODULES = List.of("core", "implementation", "mapping", "starter");
    public static final List<String> MIFOS_PROJECT_BOOT_SUPPORT_MODULES = List.of("core", "implementation", "mapping", "starter");
    // public static final List<String> MIFOS_PROJECT_BOOT_TRANSPORT_MODULES = List.of("core", "implementation", "starter");
    public static final List<String> MIFOS_PROJECT_BOOT_TRANSPORT_MODULES = List.of("rest", "grpc", "rsocket", "dubbo");
    public static final List<String> MIFOS_PROJECT_BOOT_APPLICATION_MODULES = List.of("cli", "backend", "migration", "bff", "vaadin", "jsf");
    ...
    public static final Pattern MIFOS_PROJECT_BOOT_MODULE_SERVICE_PATTERN = Pattern.compile("^.*/modules/(.*)/service/(.*)/(core|implementation|mapping|starter)/build.gradle$", Pattern.CASE_INSENSITIVE);
    public static final Pattern MIFOS_PROJECT_BOOT_MODULE_USECASE_PATTERN = Pattern.compile("^.*/modules/(.*)/usecase/(.*)/(core|implementation|mapping|starter)/build.gradle$", Pattern.CASE_INSENSITIVE);
    // public static final Pattern MIFOS_PROJECT_BOOT_MODULE_TRANSPORT_PATTERN = Pattern.compile("^.*/modules/(.*)/transport/(.*)/(core|implementation|starter)/build.gradle$", Pattern.CASE_INSENSITIVE);
    ...
    public static final Pattern MIFOS_PROJECT_BOOT_MODULE_APPLICATION_PATTERN = Pattern.compile("^.*/modules/(.*)/application/(cli|backend|migration|bff|vaadin|jsf)/build.gradle$", Pattern.CASE_INSENSITIVE);
}
