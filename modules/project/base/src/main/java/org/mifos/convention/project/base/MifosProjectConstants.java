...
public final class MifosProjectConstants {
    ...
    public static final String MIFOS_PROJECT_SUFFIX_ADAPTER = "-adapter";
    public static final String MIFOS_PROJECT_SUFFIX_FLOW = "-flow";
    ...
    public static final List<String> MIFOS_PROJECT_BOOT_FLOW_MODULES = List.of("core", "implementation", "mapping", "adapter");
    public static final List<String> MIFOS_PROJECT_BOOT_FLOW_BUSINESS_LOGIC_MODULES = List.of("service", "usecase");
    ...
    public static final Pattern MIFOS_PROJECT_BOOT_MODULE_FLOW_PATTERN = Pattern.compile("^.*/modules/(.*)/flow/(.*)/(core|mapping|adapter)/build.gradle$", Pattern.CASE_INSENSITIVE);
